...
COPILOTS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "description": (
            "Assists approved finance staff with funded-deal reconciliation, accounting "
            "classification, draft journals, statement analysis, bank-match candidates, "
            "month-close review, margin, commissions, and exception detection."
        ),
...
CAPABILITY_CONTRACTS = (
    capability(
        ...
        ["contact data", "campaign assignment", "property facts", "attempt history"],
        ...
        ["contact record", "campaign record", "provider fact timestamps"],
        ["change queue eligibility", "change assignment", "create callback"],
        ["missing phone data", "conflicting contact identity", "provider facts are stale"],
    ),
    capability(
        "prospecting_copilot",
        "call.quality_coach",
    ...
    capability(
        "finance_copilot",
        "finance.reconcile",
        "Prepare finance and accounting review",
        [
            "closing.funded",
            "closing_statement.received",
            "commission.review_requested",
            "accounting.review_requested",
            "bank_statement.imported",
            "month.close_requested",
        ],
        [
            "closing statement",
            "revenue",
        ...
        [
            "finance.read",
            "documents.read",
            "compensation.read_approved",
            "accounting_policy.read_approved",
        ],
        [
            "funding evidence",
            "statement pages",
            "plan version",
            "role-credit approvals",
            "exact source record",
            "journal line",
            "bank transaction",
        ...
        [
            ...
            "unapproved role credit",
            "ambiguous bank match",
            "unbalanced journal",
            "missing accounting evidence",
            "unexplained statement variance",
        ],
    ),
    capability(
        "finance_copilot",
