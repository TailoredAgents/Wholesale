...
export const currentRouteInventory = [
  ...
  },
  {
    ...
    queryParameters: [
      { name: "agent_user_id", status: "consumed" },
      { name: "asset_class", status: "consumed" },
      { name: "buyer_id", status: "consumed" },
      { name: "deal", status: "consumed" },
      { name: "deal_id", status: "consumed" },
      { name: "desk", status: "consumed" },
      { name: "deskPage", status: "consumed" },
      { name: "display", status: "consumed" },
      { name: "dispositionTab", status: "consumed" },
      { name: "end_at", status: "consumed" },
      { name: "market", status: "consumed" },
      { name: "scope", status: "consumed" },
      { name: "source", status: "consumed" },
      { name: "start_at", status: "consumed" },
      { name: "tab", status: "consumed" },
      { name: "view", status: "consumed" },
    ],
...
export const permissionInventory = [
  ...
  "dispositions:send_bulk_outreach",
  "dispositions:approve_outreach",
  "dispositions:approve_buyer_selection",
  "operations:view",
  "operations:manage",
  "operating_model:manage",
...
export const controlReferenceSections = [
  ...
  { heading: "Dispositions", owner: "dispositions" },
  ...
  { heading: "Browser Phone And Ask Stonegate", owner: "global" },
