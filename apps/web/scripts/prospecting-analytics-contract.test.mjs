...
test("historical native analytics remains preserved but is not routed from Prospecting", () => {
  assert.doesNotMatch(page, /getProspectingDialerAnalytics|ProspectingAnalytics/);
