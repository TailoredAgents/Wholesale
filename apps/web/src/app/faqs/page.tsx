...
const faqs = [
  ...
  { question: "How will Stonegate contact me?", answer: "We may use the phone or email information you provide for a call, email, or one-to-one text about your property inquiry. Recurring automated text messages require the separate optional unchecked SMS consent box. You can reply STOP to opt out of texts or call Stonegate for help." },
];
