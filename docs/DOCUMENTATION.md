...
| `CRM_INFORMATION_ARCHITECTURE_ROADMAP.md` | Approved target navigation, live IA1-IA3 implementation, workspace consolidation, route migration, role experience, and remaining IA phase plan | Owner, managers, and developers |
