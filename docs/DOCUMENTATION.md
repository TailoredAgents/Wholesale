...
| `VA_DIALER_ROADMAP.md` | Native Stonegate VA dialer architecture, implemented-but-inactive D0-D4 single-line foundation and browser softphone, remaining D5-D9 workflows plus D10 acceptance, BatchDialer migration bridge, and optional two- or three-line activation gates | Owner, prospecting managers, and developers |
