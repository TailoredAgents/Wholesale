...
| Resend operational email | F8.1-F8.6 and F8.7A.1-F8.7A.3 are complete; controlled transport, deterministic routing, general correspondence, and role-scoped mailbox access are implemented | Build F8.7A.4 Inbox views and global Compose, then notifications, controlled acceptance, and F8.8 production launch |
