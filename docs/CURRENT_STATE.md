...
| Resend operational email | F8.1-F8.3 decisions, provider-neutral foundation, aliases, grants, migration, owner APIs, and tested outbound Resend delivery are complete; production remains disabled | Build F8.4 inbound webhooks/recovery, then F8.5 Inbox administration |
