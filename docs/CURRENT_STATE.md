...
| Resend operational email | F8.1-F8.6 and F8.7A.1-F8.7A.5 are complete; transport, routing, scoped mailboxes, global Compose, notifications, escalation, and response reporting are implemented | Run F8.7A.6 controlled production acceptance, then approve F8.8 production launch |
