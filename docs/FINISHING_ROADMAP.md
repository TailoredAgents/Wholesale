...
| F7 Underwriting proof | V2.2, calibration, and V3 phases U3.1-U3.4 implemented | Implement U3.5-U3.10, then collect verified Georgia outcomes and operator acceptance |
...
2. Use implemented U3.2-U3.4 adaptive search, supporting evidence, manual comps, and operator
   review before adjustment expansion.
